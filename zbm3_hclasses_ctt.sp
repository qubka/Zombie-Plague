 ...
 * Record plugin info.
 **/
public Plugin HumanClassAnarhist =
{
	name        	= "[ZP] Human Class: Anarhist",
 ...
 **/
#define HUMAN_CLASS_NAME				"@Anarhist" // If string has @, phrase will be taken from translation file
#define HUMAN_CLASS_MODEL				"models/player/tm_anarchist_variantd.mdl"	
#define HUMAN_CLASS_ARM					"models/weapons/t_arms_anarchist.mdl"	

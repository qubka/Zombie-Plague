 ...
 **/
#define HUMAN_CLASS_NAME				"@SWAT" // If string has @, phrase will be taken from translation file
#define HUMAN_CLASS_MODEL				"models/player/ctm_swat.mdl"	
#define HUMAN_CLASS_ARM					"models/weapons/ct_arms_swat.mdl"	

 ...
 **/
#define HUMAN_CLASS_NAME				"@Phoenix" // If string has @, phrase will be taken from translation file
#define HUMAN_CLASS_MODEL				"models/player/tm_phoenix_variantc.mdl"	
#define HUMAN_CLASS_ARM					"models/weapons/t_arms_phoenix.mdl"	

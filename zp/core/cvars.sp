...
{    
	...
	ConVar ZMARKET_REOPEN;
	ConVar ZMARKET_FAVORITES;
	ConVar ZMARKET_PISTOL;
	ConVar ZMARKET_SHOTGUN;
	ConVar ZMARKET_RIFLE;
	ConVar ZMARKET_SNIPER;
	ConVar ZMARKET_MACH;
	ConVar ZMARKET_KNIFE;
	ConVar ZMARKET_EQUIP;

 ...
 * Record plugin info.
 **/
public Plugin HumanClassPirate =
{
	name        	= "[ZP] Human Class: Pirate",
 ...
 **/
#define HUMAN_CLASS_NAME				"@Pirate" // If string has @, phrase will be taken from translation file
#define HUMAN_CLASS_MODEL				"models/player/tm_pirate_variantc.mdl"	
#define HUMAN_CLASS_ARM					"models/weapons/t_arms_pirate.mdl"	

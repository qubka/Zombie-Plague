...
void Weapon_OnPrimaryAttack(int client, int weapon, int iClip, int iAmmo, float flCurrentTime)
{
	...
	float vKickback[] = { /*upBase = */0.15, /* lateralBase = */0.2, /* upMod = */0.15, /* lateralMod = */0.05, /* upMax = */1.5, /* lateralMax = */2.5, /* directionChange = */4.0 };
...
public Action PlasmaTouchHook(int entity, int target)
{
	if (IsValidEdict(target))
	{
		...
		ZP_EmitSoundToAll(gSoundAttack, 2, entity, SNDCHAN_STATIC, SNDLEVEL_NORMAL - 15);

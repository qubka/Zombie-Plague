 ...
 **/
#define EXTRA_ITEM_REFERENCE         "lasermine" // Name in weapons.ini from translation file
#define EXTRA_ITEM_INFO              "lasermine info" // Only will be taken from translation file 

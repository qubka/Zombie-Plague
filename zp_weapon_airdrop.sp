...
void SafeExpload(int entity)
{
	...
	for (int x = 1; x <= 5; x++)
	{
		...
		switch (x)
		{
			case 1 : UTIL_CreateShooter(entity, "forward", _, MAT_METAL, _, "models/gibs/metal_gib1.mdl", vShoot, vGib, METAL_GIBS_AMOUNT, METAL_GIBS_DELAY, METAL_GIBS_SPEED, METAL_GIBS_VARIENCE, METAL_GIBS_LIFE, METAL_GIBS_DURATION);
			case 2 : UTIL_CreateShooter(entity, "forward", _, MAT_METAL, _, "models/gibs/metal_gib2.mdl", vShoot, vGib, METAL_GIBS_AMOUNT, METAL_GIBS_DELAY, METAL_GIBS_SPEED, METAL_GIBS_VARIENCE, METAL_GIBS_LIFE, METAL_GIBS_DURATION);
			case 3 : UTIL_CreateShooter(entity, "forward", _, MAT_METAL, _, "models/gibs/metal_gib3.mdl", vShoot, vGib, METAL_GIBS_AMOUNT, METAL_GIBS_DELAY, METAL_GIBS_SPEED, METAL_GIBS_VARIENCE, METAL_GIBS_LIFE, METAL_GIBS_DURATION);
			case 4 : UTIL_CreateShooter(entity, "forward", _, MAT_METAL, _, "models/gibs/metal_gib4.mdl", vShoot, vGib, METAL_GIBS_AMOUNT, METAL_GIBS_DELAY, METAL_GIBS_SPEED, METAL_GIBS_VARIENCE, METAL_GIBS_LIFE, METAL_GIBS_DURATION);
			case 5 : UTIL_CreateShooter(entity, "forward", _, MAT_METAL, _, "models/gibs/metal_gib5.mdl", vShoot, vGib, METAL_GIBS_AMOUNT, METAL_GIBS_DELAY, METAL_GIBS_SPEED, METAL_GIBS_VARIENCE, METAL_GIBS_LIFE, METAL_GIBS_DURATION);
		}
	}

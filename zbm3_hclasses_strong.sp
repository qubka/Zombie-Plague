 ...
 * Record plugin info.
 **/
public Plugin HumanClassStrong =
{
	name        	= "[ZP] Human Class: Strong",
 ...
 **/
#define HUMAN_CLASS_NAME				"@Strong" // If string has @, phrase will be taken from translation file
#define HUMAN_CLASS_MODEL				"models/player/tm_separatist_variantd.mdl"	
#define HUMAN_CLASS_ARM					"models/weapons/t_arms_separatist.mdl"	
#define HUMAN_CLASS_HEALTH				200

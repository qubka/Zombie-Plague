 ...
 **/
#define GAME_MODE_NAME                   "nemesis"
#define GAME_MODE_DESCRIPTION            "mode nemesis" // String has taken from translation file
#define GAME_MODE_SOUND                  "ROUND_NEMESIS_SOUNDS" // Sounds has taken from sounds file
...
public void OnLibraryAdded(const char[] sLibrary)
{
    ...
    if(!strcmp(sLibrary, "zombieplague", false))
    {
        ...
        gNemesis = ZP_RegisterGameMode(GAME_MODE_NAME, 

...
#define FILE_PATH "zombie_madness1.wav"
...
public void ZP_OnEngineExecute(/*void*/)
{
	...
	g_cvDuration = CreateConVar("zp_mad_zombie_duration", "15.0", "Zombie madness durtion");
    ...
    PrecacheSound(FILE_PATH, true);
    AddFileToDownloadsTable("sound/zombie_madness1.wav");
...
public void StartMadness(int client)
{
        ...
        EmitSoundToAll(FILE_PATH,client,SNDCHAN_VOICE,hSoundLevel.IntValue);
        // Create finish timer
...
public void FinishMadness(int client){
        ...
        if (gLightOn[client])
        {
            ...
            // TODO: i dont know reason probably because not-existing entities are deleted

 ...
 **/
#define WEAPON_ITEM_REFERENCE       "janus3" // Name in weapons.ini from translation file
#define WEAPON_TIME_DELAY_SWITCH    2.2
#define WEAPON_SIGNAL_COUNTER       100
#define WEAPON_ACTIVE_COUNTER       100
#define WEAPON_TIME_DELAY_ACTIVE    0.1
...
public void ZP_OnEngineExecute(/*void*/)
{
    ...
    // Sounds
    gSound = ZP_GetSoundKeyID("JANUSIII2_SHOOT_SOUNDS");
    if(gSound == -1) SetFailState("[ZP] Custom sound key ID from name : \"JANUSIII2_SHOOT_SOUNDS\" wasn't find");
        ...
        else
        {
            ...
            if((iStateMode = GetEntProp(weaponIndex, Prop_Data, "m_iIKCounter")))
            {
                ...
                switch(ZP_GetWeaponAnimation(clientIndex))
                {
                    ...
                    case ANIM_SHOOT1 : if(iStateMode == STATE_ACTIVE) ZP_SetWeaponAnimationPair(clientIndex, weaponIndex, { ANIM_SHOOT2_1, ANIM_SHOOT2_2 }); else ZP_SetWeaponAnimation(clientIndex, ANIM_SHOOT_SIGNAL); 
